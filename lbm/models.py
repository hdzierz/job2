...
class LBMJob(models.Model):
    ...
    client = models.ForeignKey(Client, blank=True, null=True, related_name='client', on_delete=models.SET_NULL)
    ...
    dest_type = models.ForeignKey(CfgJobType, blank=True, null=True, on_delete=models.SET_NULL)
    ...
    hauler_ni = models.ForeignKey(Address, blank=True, null=True, related_name='hauler_ni', on_delete=models.SET_NULL)
    hauler_si = models.ForeignKey(Address, blank=True, null=True, related_name='hauler_si', on_delete=models.SET_NULL)
...
class LBMJobRoute(models.Model):
    ...
    job = models.ForeignKey(LBMJob, blank=True, null=True, on_delete=models.SET_NULL)
    route = models.ForeignKey(Route, blank=True, null=True, on_delete=models.SET_NULL)
    dist = models.ForeignKey(Address, blank=True, null=True, related_name='dist', on_delete=models.SET_NULL)
    subdist = models.ForeignKey(Address, blank=True, null=True, related_name='subdist', on_delete=models.SET_NULL)
    contractor = models.ForeignKey(Address, blank=True, null=True, related_name='contractor', on_delete=models.SET_NULL)
    dropoff = models.ForeignKey(Address, blank=True, null=True, related_name='dropoff', on_delete=models.SET_NULL)
    dest_type = models.ForeignKey(CfgJobType, blank=True, null=True, on_delete=models.SET_NULL)
