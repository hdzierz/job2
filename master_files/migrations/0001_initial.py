    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('island', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='master_files.Island')),
            ],
        ),
        migrations.CreateModel(
            name='Route',
            fields=[
                ...
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='master_files.Area')),
                ('island', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='master_files.Island')),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='master_files.Region')),
            ],
        ),
        migrations.CreateModel(
            name='RouteAff',
            fields=[
                ...
                ('route', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='master_files.Route')),
            ],
        ),
        migrations.CreateModel(
            name='Client',
        ...
        migrations.AddField(
            model_name='area',
            name='region',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='master_files.Region'),
        ),
        migrations.AddField(
            model_name='adresssupp',
            name='address',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='master_files.Address'),
        ),
        migrations.AddField(
            model_name='adresssupp',
            name='typ',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='master_files.CfgAdressSuppType'),
        ),
        migrations.AddField(
            model_name='address',
            name='parent',
        ...
        migrations.AddField(
            model_name='routeaff',
            name='lbm_contractor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='lbm_contractor', to='master_files.Operator'),
        ),
        migrations.AddField(
            model_name='routeaff',
            name='lbm_dist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='lbm_dist', to='master_files.Operator'),
        ),
        migrations.AddField(
            model_name='routeaff',
            name='lbm_dropoff',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='lbm_dropoff', to='master_files.Operator'),
        ),
        migrations.AddField(
            model_name='routeaff',
            name='lbm_subdist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='lbm_subdist', to='master_files.Operator'),
        ),
        migrations.AddField(
            model_name='routeaff',
            name='pcl_contractor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='pcl_contractor', to='master_files.Operator'),
        ),
        migrations.AddField(
            model_name='routeaff',
            name='pcl_dist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='pcl_dist', to='master_files.Operator'),
        ),
        migrations.AddField(
            model_name='routeaff',
            name='pcl_dropoff',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='pcl_dropoff', to='master_files.Operator'),
        ),
        migrations.AddField(
            model_name='routeaff',
            name='pcl_subdist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='pcl_subdist', to='master_files.Operator'),
        ),
        migrations.AddField(
            model_name='publication',
            name='client',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='master_files.Client'),
        ),
        migrations.AddField(
            model_name='clientprice',
            name='client',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='master_files.Client'),
        ),
    ]
